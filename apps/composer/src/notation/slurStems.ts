...
function clefMiddleStep(shape: string | null, line: string | null, dis: string | null, disPlace: string | null): number | null {
...
function middleSteps(doc: Document): Map<Element, number> {
